  ...
  return (
    <section className="bg-white rounded-md p-6 shadow-sm border border-gray-100">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="relative w-full md:w-72">
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none">
            <img src="/Search.svg" alt="icon-search" className="w-5 h-5 opacity-40" />
          </div>
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full  border-spacing-y-0">
          <tbody>
            {people.map((person, index) => (
              ...
              >
                ...
                <NavLink to="/Detail" className="py-3 px-4 text-center font-medium text-black">
                  {person.name}
                </NavLink>
                ...
                <td className="py-3 px-4 text-right">
                  <button className="p-2 hover:bg-gray-200 rounded-full transition-colors">
                    <img src="/Star.svg" alt="favorit" className="w-5 h-5 opacity-60" />
                  </button>
                </td>
              </tr>
            ))}
