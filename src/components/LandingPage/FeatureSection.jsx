function FeatureSection(){
    return (
        ...
        <div className="flex flex-col md:flex-row md:gap-32 justify-center items-center gap-2">
          <img
            src="/online-payment-security-concept-3d-phone-bill 1.svg"
            alt="image"
            className="w-xs"
          />
          <div className="benefit-detail flex flex-col gap-4 items-start ">
            ...
            <img className="img1" src="/Frame 57.svg" alt="small-fee" />
            <img className="img2" src="/Frame 58.svg" alt="data-secure" />
            <img className="img3" src="/Frame 59.svg" alt="user-friendly" />
